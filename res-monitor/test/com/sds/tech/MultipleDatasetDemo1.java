 ...
 */
public class MultipleDatasetDemo1 extends ApplicationFrame implements
		ActionListener {
	...
	public MultipleDatasetDemo1(final String title) {
		...
		final JFreeChart chart = ChartFactory.createTimeSeriesChart(
				"Multiple Dataset Demo 1", "Time", "Value", dataset1, true,
				true, false);
	...
	public void actionPerformed(final ActionEvent e) {
		...
		if (e.getActionCommand().equals("ADD_DATASET")) {
			if (this.datasetIndex < 20) {
				this.datasetIndex++;
				this.plot.setDataset(this.datasetIndex, createRandomDataset("S"
						+ this.datasetIndex));
	...
	public static void main(final String[] args) {
		...
		final MultipleDatasetDemo1 demo = new MultipleDatasetDemo1(
