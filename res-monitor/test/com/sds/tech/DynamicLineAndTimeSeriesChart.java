 ...
 */
public class DynamicLineAndTimeSeriesChart extends ApplicationFrame implements
		ActionListener {
	private static final long serialVersionUID = -3195296783407853222L;
	...
	private JFreeChart createChart(final XYDataset dataset) {
		final JFreeChart result = ChartFactory.createTimeSeriesChart(
				"Dynamic Line And TimeSeries Chart", "Time", "CPU (%)",
	...
	public void actionPerformed(final ActionEvent e) {
		...
		final double factor = 0.7 + 0.2 * Math.random();
